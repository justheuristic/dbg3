...
class _LeanFFN(torch.autograd.Function):
    @staticmethod
    @custom_fwd
    def forward(ctx, input, ln_weight, ln_bias, i2h_weight, i2h_bias, h2o_weight, h20_bias,
        ...
        hid = F.linear(input_ln, i2h_weight, i2h_bias)
        ...
        ctx.save_for_backward(input, hid, ln_weight, ln_bias, i2h_weight, h2o_weight)
    ...
    def backward(ctx, grad_output):
        ...
        input, hid, ln_weight, ln_bias, i2h_weight, h2o_weight = ctx.saved_tensors
